...
@Component({
  selector: 'app-medico-editpersona',
  templateUrl: './medico-editpersona.component.html',
  styleUrls: ['./medico-editpersona.component.css']
})
export class MedicoEditpersonaComponent implements OnInit {
