...
@Component({
  selector: 'app-examen-select',
  templateUrl: './examen-select.component.html',
  styleUrls: ['./examen-select.component.css']
})
export class ExamenSelectComponent implements OnInit {
  ...
  getExamen(idExamen:number){
    ...
    this.router.navigate(['main/fecha']);
  }
