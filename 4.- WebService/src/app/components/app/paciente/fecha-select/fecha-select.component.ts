...
@Component({
  selector: 'app-fecha-select',
  templateUrl: './fecha-select.component.html',
  styleUrls: ['./fecha-select.component.css']
})
export class FechaSelectComponent implements OnInit {
 ...
 },
 {
  ...
  getFecha(fecha:Date){
    ...
    this.router.navigate(['main/medico-select']);
  }
