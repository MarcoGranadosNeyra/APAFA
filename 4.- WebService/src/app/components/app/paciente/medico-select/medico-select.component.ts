...
@Component({
  selector: 'app-medico-select',
  templateUrl: './medico-select.component.html',
  styleUrls: ['./medico-select.component.css']
})
export class MedicoSelectComponent implements OnInit {
  ...
  getIdCalendario (idCalendario:number,hora:string) {
    ...
    */
    ...
    this.router.navigate(['main/reservarcita/']);
  }
