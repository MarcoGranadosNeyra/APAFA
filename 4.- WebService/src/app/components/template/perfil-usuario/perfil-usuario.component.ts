...
export class PerfilUsuarioComponent implements OnInit {
  ...
  constructor(private snackBar: MatSnackBar,private formBuilder: FormBuilder,private personaService:PersonaService,private uploadService:UploadService,  private router: Router,private activateRoute:ActivatedRoute) { }
  ...
  listarPersonaById(idPersona:number){
    this.personaService.listarPersonaById(idPersona).subscribe(
      res => {
        ...
        //this.getId_Sexo=this.persona.id_sexo
