...
INSERT INTO documento VALUES(1,'DNI','DOCUMENTO NACIONAL DE IDENTIDAD');
INSERT INTO documento VALUES(2,'CARNET EXTRANJERIA','CARNET EXTRANJERIA');
INSERT INTO documento VALUES(3,'PASAPORTE','PASAPORTE');
INSERT INTO documento VALUES(4,'CEDULA','CEDULA');
INSERT INTO documento VALUES(5,'PTP','PTP');
INSERT INTO documento VALUES(6,'CARNET DE REFUJIADO','CARNET DE REFUJIADO');
INSERT INTO documento VALUES(7,'RUC','RUC');

INSERT INTO rol VALUES(1,'ADMINISTRADOR',true);
INSERT INTO rol VALUES(2,'APAFA',true);
INSERT INTO rol VALUES(3,'DIRECTOR',true);
INSERT INTO rol VALUES(4,'PADRE DE FAMILIA',true);
INSERT INTO rol VALUES(5,'DOCENTE',true);
INSERT INTO rol VALUES(6,'AUDITOR',true);
INSERT INTO rol VALUES(7,'COMITE DE VIJILANCIA',true);


INSERT INTO seguro VALUES(1,'SIS','SEGURO INTEGRAL DE SALUD',true);
INSERT INTO seguro VALUES(2,'ESALUD','ESALUD',true);
INSERT INTO seguro VALUES(3,'RIMAC','RIMAC',true);
INSERT INTO seguro VALUES(4,'MAPFREE','MAPFREE',true);
INSERT INTO seguro VALUES(5,'SANITAS','SANITAS',true);
INSERT INTO seguro VALUES(6,'PACIFICO','PACIFICO',true);

insert into sexo (sexo,estado) values ('MASCULINO',true);
insert into sexo (sexo,estado) values ('FEMENINO',true);
...
INSERT INTO persona VALUES(DEFAULT,'15','1501','150101',1,'40623678','JUANITA','MONTELLANOS','SALAZAR','923667760','LURIN','1992-05-09',1,'juan.sanchez.mendez@gmail.com','https://res.cloudinary.com/sistemas-granados/image/upload/v1618018473/klgdfbwkqrkdyn1o9fui.jpg','https://res.cloudinary.com/sistemas-granados/image/upload/v1618018480/gn71gydqah5p6hlg8igf.jpg','https://image.freepik.com/foto-gratis/doctor-sonriendo-estetoscopio_1154-36.jpg',true);
INSERT INTO persona VALUES(DEFAULT,'15','1501','150101',2,'003700446','GREICY','GUEVARA','GUEVARA','923667760','av. 24 de octubre lt2 mz 27-3 de octubre de villa','1980-05-09',2,'perla.puse.parra@gmail.com','https://res.cloudinary.com/sistemas-granados/image/upload/v1618091564/e1mh9cz3wmpfgj8xyzry.jpg','https://res.cloudinary.com/sistemas-granados/image/upload/v1618018375/x3sv8qvpfd1ayan6uuz2.jpg','https://abjingenieros.com/wp-content/uploads/2020/02/doctora-sm.png',true);
INSERT INTO persona VALUES(DEFAULT,'15','1501','150101',2,'003043257','ALBA','BOLIVAR','BOLIVAR','923667760','av. 24 de octubre lt2 mz 27-3 de octubre de villa','1980-05-09',1,'juan.sanchez.mendez@gmail.com','https://res.cloudinary.com/sistemas-granados/image/upload/v1618018473/klgdfbwkqrkdyn1o9fui.jpg','https://res.cloudinary.com/sistemas-granados/image/upload/v1618018480/gn71gydqah5p6hlg8igf.jpg','https://image.freepik.com/foto-gratis/doctor-sonriendo-estetoscopio_1154-36.jpg',true);

insert into modulo(modulo,url,estado) values('usuarios','usuarios',true);
insert into modulo(modulo,url,estado) values('personas','personas',true);
insert into modulo(modulo,url,estado) values('alumnos','alumnos',true);
insert into modulo(modulo,url,estado) values('cotizaciones','cotizaciones',true);
insert into modulo(modulo,url,estado) values('eventos','eventos',true);
insert into modulo(modulo,url,estado) values('ingresos','ingresos',true);
insert into modulo(modulo,url,estado) values('gastos','gastos',true);


insert into permiso (id_rol,id_modulo,estado) values (4,4,true);
insert into permiso (id_rol,id_modulo,estado) values (4,5,true);
insert into permiso (id_rol,id_modulo,estado) values (4,6,true);
insert into permiso (id_rol,id_modulo,estado) values (4,7,true);

insert into forma_pago values(1,'EFECTIVO',1,true);
insert into forma_pago values(2,'VISA',2,true);
insert into forma_pago values(3,'YAPE',3,true);
insert into forma_pago values(4,'TRANSFERENCIA',4,true);
insert into forma_pago values(5,'TUNKY',5,true);
insert into forma_pago values(6,'LUQUITA',5,true);

/*
TODO ESTO SON PRUEBAS
*/

insert into empresa (id_documento,nro_documento,razon_social,actividad_economica,telefono,direccion,correo,contacto,estado) values (7,'10406236744','Granados IC','Servicio Tecnico','+51 923667760','Av. 24 de Octubre de Villa Lt 2','Marco.Granados.neyra@gmail.com','Ing. Marco Granados',true);

insert into cotizacion (id_empresa,id_usuario,fecha,hora,cotizacion,total,descuento,observaciones,estado) values (1,1,current_date,'10:50','REPARACION DE COMPUTADORAS','600','100','',true);

insert into cotizacion_detalle (id_cotizacion,producto,cantidad,precio,estado) values (2,'REPUESTO PLACA MADRE',1,180,true);
insert into cotizacion_detalle (id_cotizacion,producto,cantidad,precio,estado) values (2,'REPUESTO DISCO DURO',1,200,true);

insert into apertura (apertura,cierre,ingresos,descuentos,gastos,estado)values('2022-03-30','2022-03-30',0,0,0,true);
insert into padre_apoderado (id_persona,estado) values(1,true);
insert into evento (evento,fecha,hora,estado) values ('COMPRA DE COMPUTADORAS',current_date,'12:am',true);
insert into ingreso (id_usuario,id_apertura,id_evento,id_padre_apoderado,monto,fecha,hora,estado) values(1,1,1,1,20,'2022-03-30','9:50',true);

INSERT INTO GASTO (id_apertura,id_usuario,concepto,monto,fecha,hora,estado)values(1,1,'COMPRA DE REPUESTOS DE COMPUTADORA',800,current_date,to_char(current_timestamp, 'HH12:MI:SS'),true);
